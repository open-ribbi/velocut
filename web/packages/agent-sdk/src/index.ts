...
const TOOLS: Anthropic.Tool[] = [
  ...
  },
  {
    ...
    description:
      ...
      '  Prop: {model ("prop/cube"/"prop/sphere"/"prop/pillar"), position?, rotationY?, scale?, color?}. Camera: {fov? (default 40), position?, lookAt?: {x,y,z} | {character: id} (tracks the character as it moves)}.\n' +
