...
const TOOLS: Anthropic.Tool[] = [
  ...
  },
  {
    ...
    description:
      ...
      '  MANNEQUIN (char/mannequin) — the neutral poseable figure, ideal for previz/blocking that later conditions video generation: no animation clips; instead pose?: presetName | {preset?, joints?: {joint: [pitch, yaw, roll] degrees}}. Presets and joint names come from sceneAssets. Each joint axis is constant or KEYFRAMED — a keyframed pose moves (e.g. bow over a second: pose: {joints: {torso: [[{t:0,v:0},{t:1,v:45}], 0, 0]}}). color? sets the body color. gaze and attachTo (handR/handL/head) work as usual. Poses rotate joints only — for sitting/squatting/kneeling ALSO lower position.y (sitting ≈ -0.45, squat ≈ -0.55) and add a chair/box prop under the figure.\n' +
