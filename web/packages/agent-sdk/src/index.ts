  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        code: {
          type: 'string',
          description: 'JavaScript source. Top-level await is allowed; use return to produce a JSON-serializable result. Globals: velocut (apply/tts/observe/motionClip/sceneClip/sceneAssets/sceneEdit/sceneArrange/sceneImportModel/sceneInspect/directorSession/previewSession/videoGen/videoGenChannels/uploadFrame/uploadClip/uploadAsset/evaluate/document/seek) and console.',
        },
      },
      required: ['code'],
    },
