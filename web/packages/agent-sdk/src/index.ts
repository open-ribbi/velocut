...
const TOOLS: Anthropic.Tool[] = [
  ...
  },
  {
    ...
    description:
      ...
      '  SHARED GEOMETRY: sceneAssets documents geometry.create/update/remove and makeUnique edits. Use spec.geometries plus prop/instance geometryId for repeated native meshes; individual object IDs/transforms/colors remain editable. Query sceneGeometries or sceneBudget with assetId; sceneEdit preflight:true checks structure/budgets without rendering, includeSpec:false keeps bulk replies compact. Initial limits are 1000 opaque instances and 256 KiB total scene; never silently merge or simplify requested parts to bypass a limit.\n' +
